...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-7aec27c7", module.exports)
  } else {
    hotAPI.update("_v-7aec27c7", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
exports.default = {
  ...
  vuex: {
    getters: {
      todoStore: function todoStore(state) {
        return state.todoStore.todos;
      }
    },
    actions: {
      saveTodo: _todoActions.saveTodo
    }
  }
};
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<validator name=\"todoForm\">\n  <form v-on:submit.prevent=\"addTodo()\" novalidate=\"\">\n    <div class=\"form-group\">\n      <input id=\"todotext\" type=\"text\" class=\"form-control\" v-validate:todotext=\"{ required:{rule: true,message:'please add some text.'}}\" placeholder=\"Enter new Todo\" v-model=\"todo.title\">\n    </div>\n    <div class=\"form-group\" v-if=\"showError\">\n      <span v-if=\"$todoForm.todotext.required\">{{$todoForm.todotext.required}}</span>\n    </div>\n  </form>\n</validator>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-7cfdd07d", module.exports)
  } else {
    hotAPI.update("_v-7cfdd07d", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"./todoActions":10,"vue":5,"vue-hot-reload-api":2}],9:[function(require,module,exports){
'use strict';
...
exports.default = {
  ...
  vuex: {
    ...
    actions: {
      getTodos: _todoActions.getTodos, deleteTodo: _todoActions.deleteTodo, completedTodo: _todoActions.completedTodo
    }
  }
};
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div>\n  <ul class=\"list-group\">\n    <li v-for=\"todo in todoStore\" class=\"list-group-item\" v-bind:class=\"{ 'completed' : todo.completed }\">\n        {{todo.title}}\n        <button class=\"btn btn-xs btn-danger pull-right\" @click=\"todoDelete(todo)\">\n          <i class=\"fa fa-trash\"></i>\n        </button>\n        <button class=\"btn btn-xs pull-right margin-right-10\" v-bind:class=\"{'btn-success' : todo.completed, 'btn-warning' : !todo.completed}\" v-on:click=\"todoCompleted(todo)\">{{todo.completed ? 'Completed' : 'Pending'}}</button>\n      </li>\n  </ul>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-333279b8", module.exports)
  } else {
    hotAPI.update("_v-333279b8", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"./todoActions":10,"vue":5,"vue-hot-reload-api":2}],10:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
var getTodos = exports.getTodos = function getTodos(store) {
  this.$http.get('api/v1/todos').then(function (response) {
    var dispatch = store.dispatch;
    dispatch('GET_TODOS', response.data);
  });
};
var saveTodo = exports.saveTodo = function saveTodo(store, postData) {
...
var deleteTodo = exports.deleteTodo = function deleteTodo(store, todo) {
...
var completedTodo = exports.completedTodo = function completedTodo(store, todo) {
  var postData = { id: todo.id };
...
var mutations = {
  ...
  ADD_TODOS: function ADD_TODOS(state, todo) {
    state.todos.push(todo);
  },
  DELETE_TODOS: function DELETE_TODOS(state, todo) {
    state.todos.$remove(todo);
  },
  COMPLETED_TODOS: function COMPLETED_TODOS(state, todo) {
    todo.completed = !todo.completed;
  }
};
exports.default = {
...
var _TodoHeader = require('./components/TodoHeader.vue');
...
_vue2.default.component('todo-item', _TodoItems2.default);
_vue2.default.component('todo-add-form', _TodoAddForm2.default);
_vue2.default.component('todo-header', _TodoHeader2.default);
...
},{"./components/Todo/TodoAddForm.vue":8,"./components/Todo/TodoItems.vue":9,"./components/TodoHeader.vue":7,"./vuex/store":13,"vue":5,"vue-resource":3,"vue-validator":4}],13:[function(require,module,exports){
(function (process){
'use strict';
...
var _todoStore = require('./../components/Todo/todoStore');
...
},{"./../components/Todo/todoStore":11,"_process":1,"vue":5,"vuex":6}]},{},[12]);
